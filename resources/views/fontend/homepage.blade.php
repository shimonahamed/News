        ...
        <div class="row">
            <div class="col-lg-8">
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        <div class="position-relative mb-3">
                            ...
                            <div class="bg-white border border-top-0 p-4">
                                ...
                                <a class="h4 d-block mb-3 text-secondary text-uppercase font-weight-bold" href="">{{$latnews->title}}</a>
                            </div>
                            ...
                            <div class="col-lg-6">
                                ...
                                <div class="d-flex align-items-center bg-white mb-3" style="height: 110px;">
                                    ...
                                    <div class="w-100 h-100 px-3 d-flex flex-column justify-content-center border border-left-0">
                                        ...
                                        <a class="h6 m-0 text-secondary text-uppercase font-weight-bold" href="">{{$latnews->title}}</a>
                                    </div>
                                </div>
                        ...
                        <div class="row news-lg mx-0 mb-3">
                            ...
                            <div class="col-md-6 d-flex flex-column border bg-white h-100 px-0">
                                <div class="mt-auto p-4">
                                    ...
                                    <a class="h4 d-block mb-3 text-secondary text-uppercase font-weight-bold" href="">{{$ltnews->title}}</a>
                    ...
                    <div class="col-lg-6">
                        ...
                        <div class="d-flex align-items-center bg-white mb-3" style="height: 110px;">
                            <img class="img-fluid" src="{{env('STORAGE_PATH')}}/{{$ltnew->img}}" alt="">
                            <div class="w-100 h-100 px-3 d-flex flex-column justify-content-center border border-left-0">
                                <div class="mb-2">
                                    <a class="badge badge-primary text-uppercase font-weight-semi-bold p-1 mr-2"
                                ...
                                <a class="h6 m-0 text-secondary text-uppercase font-weight-bold" href="">{{$ltnew->title}}</a>
                            </div>
                        </div>
            ...
            <div class="col-lg-4">
                ...
                <div class="mb-3">
                    ...
                    <div class="bg-white border border-top-0 p-3">
                        <div class="d-flex align-items-center bg-white mb-3" style="height: 110px;">
                            <img class="img-fluid" src="{{asset('fontend/img/news-110x110-1.jpg')}}" alt="">
                            <div class="w-100 h-100 px-3 d-flex flex-column justify-content-center border border-left-0">
                                <div class="mb-2">
                        ...
                        <div class="d-flex align-items-center bg-white mb-3" style="height: 110px;">
                            <img class="img-fluid" src="{{asset('fontend/img/news-110x110-2.jpg')}}" alt="">
                            <div class="w-100 h-100 px-3 d-flex flex-column justify-content-center border border-left-0">
                                <div class="mb-2">
                                    <a class="badge badge-primary text-uppercase font-weight-semi-bold p-1 mr-2" href="">Business</a>
                                    <a class="text-body" href=""><small>Jan 01, 2045</small></a>
                        ...
                        <div class="d-flex align-items-center bg-white mb-3" style="height: 110px;">
                            <img class="img-fluid" src="{{asset('fontend/img/news-110x110-3.jpg')}}" alt="">
                            <div class="w-100 h-100 px-3 d-flex flex-column justify-content-center border border-left-0">
                                <div class="mb-2">
                                    <a class="badge badge-primary text-uppercase font-weight-semi-bold p-1 mr-2" href="">Business</a>
                                    <a class="text-body" href=""><small>Jan 01, 2045</small></a>
                        ...
                        <div class="d-flex align-items-center bg-white mb-3" style="height: 110px;">
                            <img class="img-fluid" src="{{asset('fontend/img/news-110x110-4.jpg')}}" alt="">
                            <div class="w-100 h-100 px-3 d-flex flex-column justify-content-center border border-left-0">
                                <div class="mb-2">
                                    <a class="badge badge-primary text-uppercase font-weight-semi-bold p-1 mr-2" href="">Business</a>
                                    <a class="text-body" href=""><small>Jan 01, 2045</small></a>
                        ...
                        <div class="d-flex align-items-center bg-white mb-3" style="height: 110px;">
                            <img class="img-fluid" src="{{asset('fontend/img/news-110x110-5.jpg')}}" alt="">
                            <div class="w-100 h-100 px-3 d-flex flex-column justify-content-center border border-left-0">
                                <div class="mb-2">
                                    <a class="badge badge-primary text-uppercase font-weight-semi-bold p-1 mr-2" href="">Business</a>
                                    <a class="text-body" href=""><small>Jan 01, 2045</small></a>
