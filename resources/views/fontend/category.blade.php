...
<head>
    <meta charset="utf-8">
    <title>{{__('public.categor.' . @$category->categrory_name )}}</title>
                        ...
                        <div class="col-lg-6">
                            <div class="position-relative mb-3">
                                ...
                                <div class="bg-white border border-top-0 p-4">
                                    ...
                                    <p class=" d-block mb-3 text-secondary text-uppercase " href="{{route('wb.news', $latnews->id)}}">{{ Str::limit(strip_tags($latnews->details), 180, '...') }}</p>
                                ...
                                <div class="d-flex justify-content-between bg-white border border-top-0 p-4">
                                    ...
                                    <div class="d-flex align-items-center">
                                        ...
                                        <small class="ml-3"><i class="far fa-comment mr-2"></i>{{count($comments)}}</small>
                                    </div>
                                </div>
